      ...
      {isOpen && (
        <div className="fixed cursor-default inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden relative z-10"
          ...
          >
            ...
            <div className="w-[35.5%] h-1 mx-6 rounded-full bg-gray-200 shrink-0"></div>
