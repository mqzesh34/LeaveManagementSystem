    ...
    return (
        <div className="flex w-screen h-screen bg-gray-200">
            <div className="flex justify-between items-center ml-12 gap-6 flex-1 w-full">
                <div className="flex w-full max-w-[30%]  flex-col" id={"login-form"}>
                    <div className="p-8 rounded-xl border-b-5 border-3 bg-white border-gray-900">
                        ...
                        <form className="flex flex-col gap-7 text-lg" onSubmit={handleSubmit}>
                            <div className="relative flex items-center text-center">
                                ...
                                <input
                                    ...
                                    placeholder="E-posta"
                                    /* pl-10 ekleyerek metni ikonun sağından başlattık */
                            ...
                            <button
                                className="p-3 rounded-lg bg-gray-800 text-white text-lg border-2 border-gray-900 hover:bg-gray-700 transition">
                                Giriş Yap
                            </button>
